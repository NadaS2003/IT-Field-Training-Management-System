...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white border-l border-gray-100 flex flex-col">
        ...
        <nav class="flex-1 px-4 space-y-2">
            <a href="{{ route('company.dashboard') }}" onclick="handleNavClick(this)" class="nav-item flex items-center px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-xl transition {{ Route::currentRouteName() == 'company.dashboard' ? 'nav-item-active' : '' }}">
                <i class="fas fa-home ml-3"></i>
                <span class="text-sm font-medium">الرئيسية</span>
            </a>


            <a href="{{ route('company.showInternships') }}" onclick="handleNavClick(this)" class="nav-item flex items-center px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-xl transition {{ Route::currentRouteName() == 'company.showInternships' ? 'nav-item-active' : '' }}">
                <i class="fas fa-briefcase ml-3"></i>
                <span class="text-sm font-medium">الفرص التدريبية</span>
            </a>

            <a href="{{ route('company.trainingRequests') }}" onclick="handleNavClick(this)" class="nav-item flex items-center px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-xl transition {{ Route::currentRouteName() == 'company.trainingRequests' ? 'nav-item-active' : '' }}">
                <i class="fas fa-file-import ml-3"></i>
                <span class="text-sm font-medium">طلبات التدريب</span>
            </a>

            <a href="{{ route('company.approved_students') }}" onclick="handleNavClick(this)" class="nav-item flex items-center px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-xl transition {{ Route::currentRouteName() == 'company.approved_students' ? 'nav-item-active' : '' }}">
                <i class="fas fa-user-group ml-3"></i>
                <span class="text-sm font-medium">الطلاب المقبولين</span>
            </a>

            <a href="{{ route('company.reportsAndRates') }}" onclick="handleNavClick(this)" class="nav-item flex items-center px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-xl transition {{ Route::currentRouteName() == 'company.reportsAndRates' ? 'nav-item-active' : '' }}">
                <i class="fas fa-star ml-3"></i>
                <span class="text-sm font-medium">التقييمات و التقارير</span>
            </a>

            <a href="{{ route('company.profile') }}" onclick="handleNavClick(this)" class="nav-item flex items-center px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-xl transition {{ Route::currentRouteName() == 'company.profile' ? 'nav-item-active' : '' }}">
                <i class="fas fa-file ml-3"></i>
                <span class="text-sm font-medium">ملف الشركة</span>
            </a>
